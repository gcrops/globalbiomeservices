    ...
    <div>
      ...
      <div>
        ...
        <div className="MainServicePage">
          ...
          its core engineering and leadership groups. <br />
          <br />
          These extended teams are composed of specialists across data
          engineering, machine learning, cloud infrastructure, security, and
          ...
          <br />
          <br />
          Operationally, extended teams take ownership of critical systems that
          keep the platform running reliably. They manage data pipelines,
          monitor AI model performance, maintain cloud infrastructure, and
          enforce security controls around the clock. Clear service-level
          objectives, shared dashboards, and automated alerts enable proactive
          issue detection and rapid response, minimizing downtime and
          operational risk across global deployments. <br />
          <br />
          Beyond day-to-day operations, extended teams play a key role in
          continuous improvement and innovation. They help modernize legacy
          ...
          organization to focus on delivering high-impact geospatial
          intelligence while confidently operating at global scale.
        </div>
      </div>
    </div>
  );
