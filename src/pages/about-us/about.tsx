    ...
    <div>
      ...
      <div className="aboutcontent">
        <div className="content45">
          ...
          <p>
            We maximize business value and ROI through cloud enablement,
        ...
        <div className="content45">
          <p>
            We deliver the value that clients care about; we provide ideas and
            solutions tailor-made to meet their needs and produce results of the
            highest quality.Our clients look forward to us for innovative ideas,
            expertise, and solutions that help them improve the entire gamut of
            their business.
          </p>
          <p>
